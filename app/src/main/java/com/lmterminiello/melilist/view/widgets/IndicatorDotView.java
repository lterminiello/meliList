...
public class IndicatorDotView extends View {
    ...
    private void setup(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray ta = context.obtainStyledAttributes(attributeSet, R.styleable.indicatorDotView);
            activePaint.setStyle(Paint.Style.FILL);
            activePaint.setColor(ta.getColor(R.styleable.indicatorDotView_activeColor, resources.getColor(R.color.white)));
            inactivePaint.setStyle(Paint.Style.FILL);
            inactivePaint.setColor(ta.getColor(R.styleable.indicatorDotView_inactiveColor, resources.getColor(R.color.grayDot)));
            activeDotSize = ta.getDimensionPixelSize(R.styleable.indicatorDotView_activeSize, resources.getDimensionPixelSize(R.dimen.dotActiveSize));
            inactiveDotSize = ta.getDimensionPixelSize(R.styleable.indicatorDotView_inactiveSize, resources.getDimensionPixelSize(R.dimen.dotInactiveSize));
            mediumDotSize = ta.getDimensionPixelSize(R.styleable.indicatorDotView_mediumSize, resources.getDimensionPixelSize(R.dimen.dotMediumSize));
            smallDotSize = ta.getDimensionPixelSize(R.styleable.indicatorDotView_smallSize, resources.getDimensionPixelSize(R.dimen.dotSmallSize));
            dotMargin = ta.getDimensionPixelSize(R.styleable.indicatorDotView_margin, resources.getDimensionPixelSize(R.dimen.dotMargin));
            setVisibleDotCounts(ta.getInteger(R.styleable.indicatorDotView_visibleDots, DEFAULT_VISIBLE_DOTS_COUNT));
    ...
    public void setActiveDotColor(int color) {
        activePaint.setColor(ResourcesCompat.getColor(getResources(), color, null));
    }

    public void setInactiveDotColor(int color) {
        inactivePaint.setColor(ResourcesCompat.getColor(getResources(), color, null));
    }
